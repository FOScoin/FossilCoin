Contributing to FossilCoin Core
============================

The FossilCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the FossilCoin Core project, and is not to be
confused with overall FossilCoin Network Protocol consensus changes.

Whether a pull request is merged into FossilCoin Core rests with the project merge
...
Patches that change FossilCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the FossilCoin consensus, it must have been
...
The project leader is the release manager for each FossilCoin Core release.
