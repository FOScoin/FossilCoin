...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("FossilCoin Core fossilcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  fossilcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fossilcoin transaction") + "\n" +
                               "  fossilcoin-tx [options] -create [commands]   " + _("Create hex-encoded fossilcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded fossilcoin transaction
