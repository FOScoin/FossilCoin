...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000bebcbd07158f28ed9d186d3900b94094f1368024c2780620971e6660682"));
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 2727;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // FossilCoin starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // FossilCoin: 1 day
        nTargetSpacing = 1 * 120;  // FossilCoin: 2 Minutes
        nMaturity = 5;
        nMasternodeCountDrift = 20;
        nMaxMoneyOut = 5424835 * COIN;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "JPMorgan (JPM) Q1 Earnings Beat on Better Rates and Trading  - Aug 6 2018 - Made in england - UK";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1533666944;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 725594;
				
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000bebcbd07158f28ed9d186d3900b94094f1368024c2780620971e6660682"));
        assert(genesis.hashMerkleRoot == uint256("0x35efd32b4fc747f5b2a2c45c45ced3b21f5848e2fbbcb58c6059c6bbf34e1d18"));

        vSeeds.push_back(CDNSSeedData("fossilcoin.seeds.mn.zone", "fossilcoin.seeds.mn.zone"));   // DNS SEEDER
		vSeeds.push_back(CDNSSeedData("fossilcoin.mnseeds.com", "fossilcoin.mnseeds.com"));       // DNS SEEDER
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // FossilCoin: 1 day
        nTargetSpacing = 1 * 60;  // FossilCoin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet fossilcoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet fossilcoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet fossilcoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet fossilcoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet fossilcoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // FossilCoin: 1 day
        nTargetSpacing = 1 * 60;        // FossilCoin: 1 minutes
