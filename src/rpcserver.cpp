...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FossilCoin features */
        {"fossilcoin", "masternode", &masternode, true, true, false},
        {"fossilcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"fossilcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fossilcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fossilcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fossilcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"fossilcoin", "startmasternode", &startmasternode, true, true, false},
        {"fossilcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fossilcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fossilcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fossilcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fossilcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fossilcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fossilcoin", "mnbudget", &mnbudget, true, true, false},
        {"fossilcoin", "preparebudget", &preparebudget, true, true, false},
        {"fossilcoin", "submitbudget", &submitbudget, true, true, false},
        {"fossilcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fossilcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fossilcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fossilcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fossilcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fossilcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fossilcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fossilcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"fossilcoin", "mnsync", &mnsync, true, true, false},
        {"fossilcoin", "spork", &spork, true, true, false},
        {"fossilcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"fossilcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use fossilcoind, or the -server option to fossilcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> fossilcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2828/\n";
}
