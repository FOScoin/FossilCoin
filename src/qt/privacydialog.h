...
public:
    ...
    void setZFossilCoinControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzFOS_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzFOS_clicked();
    void on_pushButtonZFossilCoinControl_clicked();
