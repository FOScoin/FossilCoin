                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("FossilCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fossilcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zFOS"));
...
//    connect(privacyAction, SIGNAL(triggered()), this, SLOT(gotoPrivacyPage()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About FossilCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about FossilCoin Core"));
    ...
    openAction->setStatusTip(tr("Open a FossilCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FossilCoin Core help message to get a list with possible FossilCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("FossilCoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("FossilCoin Core"); // default title
...
/** Creates context menu, its actions, and fossilcoins up all the relevant signals for mouse events. */
