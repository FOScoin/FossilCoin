...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("FossilCoin Core"),
     ...
     * override -datadir in the fossilcoin.conf file in the default data directory
     * (to be consistent with fossilcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
