...
/** Utility functions used by the FossilCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render FossilCoin addresses in monospace font
...
// Parse "fossilcoin:" URI into recipient object, return true on successful parsing
