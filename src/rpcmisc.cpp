...
// Copyright (c) 2017-2018 The FossilCoin developers
...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total fossilcoin balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zFOSsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zFOS denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zFOS denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zFOS denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zFOS denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zFOS denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zFOS denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zFOS denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zFOS denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zFOS denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in fossilcoin/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in fossilcoin/kb\n"
    ...
    Object zfossilcoinObj;
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zfossilcoinObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zfossilcoinObj.emplace_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.emplace_back(Pair("zFOSsupply", zfossilcoinObj));
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nReturn information about the given fossilcoin address.\n"
            "\nArguments:\n"
            "1. \"fossilcoinaddress\"     (string, required) The fossilcoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"fossilcoinaddress\", (string) The fossilcoin address validated\n"
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are fossilcoin addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) fossilcoin address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"fossilcoinaddress\"  (string, required) The fossilcoin address to use for the signature.\n"
