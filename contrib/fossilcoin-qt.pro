...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/fossilcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/fossilcoin-cli.cpp \
           src/fossilcoin-tx.cpp \
           src/fossilcoin.cpp \
           src/db.cpp \
           ...
           src/qt/fossilcoin.cpp \
           src/qt/fossilcoinstrings.cpp \
...
RESOURCES += src/qt/fossilcoin.qrc src/qt/fossilcoin_locale.qrc

TRANSLATIONS += src/qt/locale/fossilcoin_bg.ts \
                src/qt/locale/fossilcoin_de.ts \
                src/qt/locale/fossilcoin_en.ts \
                src/qt/locale/fossilcoin_es.ts \
                src/qt/locale/fossilcoin_fi.ts \
                src/qt/locale/fossilcoin_fr.ts \
                src/qt/locale/fossilcoin_it.ts \
                src/qt/locale/fossilcoin_ja.ts \
                src/qt/locale/fossilcoin_pl.ts \
                src/qt/locale/fossilcoin_pt.ts \
                src/qt/locale/fossilcoin_ru.ts \
                src/qt/locale/fossilcoin_sk.ts \
                src/qt/locale/fossilcoin_sv.ts \
                src/qt/locale/fossilcoin_vi.ts \
                src/qt/locale/fossilcoin_zh_CN.ts \
                src/qt/locale/fossilcoin_zh_TW.ts
